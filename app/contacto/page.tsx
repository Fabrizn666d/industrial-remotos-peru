      ...
      <section className="contact-section">
        <div className="page-shell contact-layout">
          <aside className="contact-info">
            ...
            <div><a href={"tel:+" + siteConfig.whatsappNumber}><Phone size={19} /><span><small>Teléfono / WhatsApp</small>{siteConfig.phoneDisplay}</span></a><span><MapPin size={19} /><i><small>Ubicación</small>{siteConfig.location}</i></span><span><Clock3 size={19} /><i><small>Horario</small>{siteConfig.hours}</i></span></div>
