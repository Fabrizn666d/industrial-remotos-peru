  ...
  return (
    <div className="assistant-experience assistant-v2">
      <section className="assistant-chat glass-panel" aria-live="polite">
        ...
        <div className="assistant-chat__intro"><span className="eyebrow eyebrow--light">Asistente inteligente</span><h2>Diseñemos la solución correcta para tu proyecto.</h2><p>Cuéntanos qué necesitas y prepararemos una recomendación inicial.</p></div>
